...
public class Vigenere {
    ...
    public static void main(String[] args) {
        ...
        String schlüssel = key.nextLine().toUpperCase(); //nur Großbuchstaben

        int a = wort.length() ;

        //mache Schlüsselwort mindestens gleich lang wie zu verschlüsselndes Wort
        int b = a / schlüssel.length();
        String hilfe = schlüssel;
        for (int i = 1; i <= b ; i++) {
            schlüssel = schlüssel + hilfe;
        }
        ...
        for (int i = 0; i <= a-1 ; i++ ) {
            System.out.print("" + verwort.charAt(i));
        }
        ...
        //mache Entschlüsselwort mindestens gleich lang wie zu verschlüsseltes Wort
        b = a / entschlüssel.length();
        hilfe = entschlüssel;
        for (int i = 1; i <= b ; i++) {
            entschlüssel = entschlüssel + hilfe;
        }
        ...
        for (int i = 0; i <= a-1; i++) {
            System.out.print("" + ursprung.charAt(i));
        }
