    ...
    public static int[] bubblesort(int[] a) {
        ...
        for(int i=0; i<a.length-1; i++) {
            for(int j=1; j<a.length; j++) {
                ...
                System.out.println("a[j-1]>a[j]?, d.h." + a[j-1] + ">" + a[j] + "?");
                if(a[j-1]>a[j]) {
                    System.out.println("ja - tauschen!");
                    int temp=a[j-1]; System.out.println("temp = a[j-1] = " + temp);
                    a[j-1]=a[j]; System.out.println("a[j-1] = a[j] = " + a[j-1]);
                    a[j]=temp; System.out.println("a[j] = temp = " + temp);
